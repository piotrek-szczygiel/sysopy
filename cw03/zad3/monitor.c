...
void monitor(int element)
{
    ...
    user_time = rusage.ru_utime.tv_sec * 1.0 + rusage.ru_utime.tv_usec / 1000000.0;
    system_time = rusage.ru_stime.tv_sec * 1.0 + rusage.ru_stime.tv_usec / 1000000.0;
    printf("PID: %d SELF    \tu_time: %.6fs  s_time: %.6fs  maxrss: %ld\n",
        pid, user_time, system_time, rusage.ru_maxrss);
